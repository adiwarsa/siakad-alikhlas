                        ...
                        <div class="card-header">
                            <h4>Data Santri</h4>
                                <div class="card-header-action">
                                    <a href="{{ url('santri/create') }}" class="btn btn-icon btn-primary"><i class="fas fa-plus"></i></a>
                                </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-striped" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <a href="{{ url('/santri/' .$str->id. '/edit') }}" class="btn btn-icon btn-warning"><i class="far fa-edit"></i></a>
